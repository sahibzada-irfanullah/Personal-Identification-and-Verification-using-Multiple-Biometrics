function [match]= picPatMach(tstImgPath,extImgPath)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here


% J1=imresize(imread('1.tif'),[200 200]);
J1=imresize(imread(tstImgPath),[200 200]);
J2=imresize(imread(extImgPath),[200 200]);
% imshow(J1);
% figure,imshow(J2);
% imshow(J)
J1=J1(:,:,1)>160;
...
match=compEdgesNtPixles(np1,np2,r-1);
% % match=0;
% % for i=1:r-1
% % 
% % if np1(i)==np2(i)
